...
const jeopardyCategories = [
  {
    ...
    questions: [
      ...
      {
        question: "Who designed the second car?",
        answers: ["Karl Benz", "Henry Ford2"],
        correct: "Karl Benz",
        level: "hard",
      },
    ],
...
function addCategory(category) {
  ...
  column.classList.add("gener-column");
  ...
  category.questions.forEach((question) => {
    ...
    if (question.level === "easy") card.innerHTML = 100;
    if (question.level === "medium") card.innerHTML = 200;
    if (question.level === "hard") card.innerHTML = 300;
